...
//Saída
//Para cada caso de teste de entrada do seu programa, você deve imprimir um número inteiro 
//contendo a quantidade de dígitos do resultado da potência calculada no respectivo caso de teste.
...
for (let i = 0; i < C; i++) {
    ...
    let digitosN = (Math.log10(N) + 1).toFixed(0)

    // Calcula o número de dígitos de nm
    let digitosNM = (Math.log10(N ** M) + 1).toFixed(0)
